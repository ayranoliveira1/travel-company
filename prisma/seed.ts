      ...
      data: [
         {
            ...
            locationDescription:
               "Amalfi, Itália, é um lugar de férias ideal, para muitos turistas e muitos curiosos dada a presença constante, durante todo o ano, de muitas celebridades, um lugar comparado com a Riviera Francesa e dos mais solicitados e populares.",
            countryCode: "IT",
            coverImage:
         ...
         },
         {
            ...
            locationDescription:
               "New York, Estados Unidos, é famoso por possuir uma infinidade de locais e pontos turísticos para todos os gostos e fins. Alguns lugares são tão incríveis de se visitar que são unanimidade entre os turistas, mas existem outros que possuem uma energia tão boa quanto e ainda assim, não são conhecidos do mesmo jeito.",
            countryCode: "US",
            coverImage:
         ...
         },
         {
            ...
            locationDescription:
               "Florença, Itália, é uma cidade conhecida como o berço do Renascimento e lar de algumas das obras de arte e esculturas mais famosas do mundo. Por lá também estão alguns dos edifícios mais belos e emblemáticos do mundo, incluindo o Duomo, o Palazzo Vecchio e a Ponte Vecchio.",
            countryCode: "IT",
            coverImage:
               "https://images.unsplash.com/photo-1534612899740-55c821a90129?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80",
            imagesUrl: [
         ...
         },
         {
            ...
            locationDescription:
               "Lago Sereno, Suíça, é um lugar tranquilo localizado na pitoresca cidade de St. Moritz, na Suíça. Ele está situado no colo da natureza e oferece vistas cativantes das montanhas suíças. O lago é conhecido por sua reflexão espelhada, adicionando à sua esplêndida beleza. ",
            countryCode: "CH",
            coverImage:
         ...
         },
         {
            ...
            locationDescription:
               "Madrid, Espanha, caminhar por aqui significa ver lugares icônicos como o impressionante Palácio Real, a Plaza Mayor com mais de 400 anos de história, a agitadíssima Puerta del Sol, a conhecida rua Gran Vía cheia de lojas, e os quatro edifícios mais altos de toda a Espanha.",
            countryCode: "ES",
            coverImage:
         ...
         },
         {
            ...
            locationDescription:
               "Montreal, Canadá, é considerada por muitos como a cidade mais criativa do Canadá. Para apreciar essa a arte de rua, as regiões de St. Laurent e St. Dominique são imperdíveis, enquanto o Museu de Belas Artes também se destaca por ter exposições belíssimas e de grande prestígio.",
            countryCode: "CA",
            coverImage:
               "https://images.unsplash.com/photo-1596394516093-501ba68a0ba6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80",
            imagesUrl: [
         ...
         },
         {
            ...
            locationDescription:
               "Oslo, Noruega. Um dos principais atrativos turísticos da Noruega é seu majestoso entorno natural, um inigualável manto verde de luz que envolve paisagens dos sonhos formadas por uma das formações geográficas mais surpreendentes do mundo: os fiordes. Para descobrir sua arte.",
            countryCode: "NO",
            coverImage:
         ...
         },
         {
            ...
            locationDescription:
               "Paris, França, é conhecida por sua rica cultura, história e muitas atrações turísticas. Alguns pontos turísticos dos mais populares em Paris incluem a Torre Eiffel, o museu de arte do Louvre, o Arco do Triunfo, os Champs-Élysées e o Rio Sena, onde você pode fazer passeios a barco.",
            countryCode: "FR",
            coverImage:
